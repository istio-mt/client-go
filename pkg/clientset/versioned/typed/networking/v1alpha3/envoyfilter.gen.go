...
type EnvoyFilterInterface interface {
	...
	UpdateStatus(*v1alpha3.EnvoyFilter) (*v1alpha3.EnvoyFilter, error)
...
func (c *envoyFilters) UpdateStatus(envoyFilter *v1alpha3.EnvoyFilter) (result *v1alpha3.EnvoyFilter, err error) {
	result = &v1alpha3.EnvoyFilter{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("envoyfilters").
