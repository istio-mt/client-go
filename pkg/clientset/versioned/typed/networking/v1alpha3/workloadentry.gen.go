...
type WorkloadEntryInterface interface {
	...
	UpdateStatus(*v1alpha3.WorkloadEntry) (*v1alpha3.WorkloadEntry, error)
...
func (c *workloadEntries) UpdateStatus(workloadEntry *v1alpha3.WorkloadEntry) (result *v1alpha3.WorkloadEntry, err error) {
	result = &v1alpha3.WorkloadEntry{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("workloadentries").
