...
type DestinationRuleInterface interface {
	Create(*v1beta1.DestinationRule) (*v1beta1.DestinationRule, error)
	Update(*v1beta1.DestinationRule) (*v1beta1.DestinationRule, error)
	UpdateStatus(*v1beta1.DestinationRule) (*v1beta1.DestinationRule, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta1.DestinationRule, error)
	List(opts v1.ListOptions) (*v1beta1.DestinationRuleList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.DestinationRule, err error)
...
func (c *destinationRules) Get(name string, options v1.GetOptions) (result *v1beta1.DestinationRule, err error) {
...
func (c *destinationRules) List(opts v1.ListOptions) (result *v1beta1.DestinationRuleList, err error) {
...
func (c *destinationRules) Create(destinationRule *v1beta1.DestinationRule) (result *v1beta1.DestinationRule, err error) {
	result = &v1beta1.DestinationRule{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("destinationrules").
...
func (c *destinationRules) Update(destinationRule *v1beta1.DestinationRule) (result *v1beta1.DestinationRule, err error) {
	result = &v1beta1.DestinationRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("destinationrules").
...
func (c *destinationRules) UpdateStatus(destinationRule *v1beta1.DestinationRule) (result *v1beta1.DestinationRule, err error) {
	result = &v1beta1.DestinationRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("destinationrules").
...
func (c *destinationRules) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.DestinationRule, err error) {
	result = &v1beta1.DestinationRule{}
