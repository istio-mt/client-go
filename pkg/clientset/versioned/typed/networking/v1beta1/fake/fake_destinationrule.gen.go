...
func (c *FakeDestinationRules) Get(name string, options v1.GetOptions) (result *v1beta1.DestinationRule, err error) {
	obj, err := c.Fake.
...
func (c *FakeDestinationRules) List(opts v1.ListOptions) (result *v1beta1.DestinationRuleList, err error) {
	obj, err := c.Fake.
...
func (c *FakeDestinationRules) Create(destinationRule *v1beta1.DestinationRule) (result *v1beta1.DestinationRule, err error) {
	obj, err := c.Fake.
...
func (c *FakeDestinationRules) Update(destinationRule *v1beta1.DestinationRule) (result *v1beta1.DestinationRule, err error) {
	obj, err := c.Fake.
...
func (c *FakeDestinationRules) UpdateStatus(destinationRule *v1beta1.DestinationRule) (*v1beta1.DestinationRule, error) {
	obj, err := c.Fake.
...
func (c *FakeDestinationRules) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.DestinationRule, err error) {
	obj, err := c.Fake.
