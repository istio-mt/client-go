...
func (c *FakeSidecars) Get(name string, options v1.GetOptions) (result *v1beta1.Sidecar, err error) {
	obj, err := c.Fake.
...
func (c *FakeSidecars) List(opts v1.ListOptions) (result *v1beta1.SidecarList, err error) {
	obj, err := c.Fake.
...
func (c *FakeSidecars) Create(sidecar *v1beta1.Sidecar) (result *v1beta1.Sidecar, err error) {
	obj, err := c.Fake.
...
func (c *FakeSidecars) Update(sidecar *v1beta1.Sidecar) (result *v1beta1.Sidecar, err error) {
	obj, err := c.Fake.
...
func (c *FakeSidecars) UpdateStatus(sidecar *v1beta1.Sidecar) (*v1beta1.Sidecar, error) {
	obj, err := c.Fake.
...
func (c *FakeSidecars) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.Sidecar, err error) {
	obj, err := c.Fake.
