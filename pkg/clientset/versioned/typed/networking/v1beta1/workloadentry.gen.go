...
type WorkloadEntryInterface interface {
	Create(*v1beta1.WorkloadEntry) (*v1beta1.WorkloadEntry, error)
	Update(*v1beta1.WorkloadEntry) (*v1beta1.WorkloadEntry, error)
	UpdateStatus(*v1beta1.WorkloadEntry) (*v1beta1.WorkloadEntry, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta1.WorkloadEntry, error)
	List(opts v1.ListOptions) (*v1beta1.WorkloadEntryList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.WorkloadEntry, err error)
...
func (c *workloadEntries) Get(name string, options v1.GetOptions) (result *v1beta1.WorkloadEntry, err error) {
...
func (c *workloadEntries) List(opts v1.ListOptions) (result *v1beta1.WorkloadEntryList, err error) {
...
func (c *workloadEntries) Create(workloadEntry *v1beta1.WorkloadEntry) (result *v1beta1.WorkloadEntry, err error) {
	result = &v1beta1.WorkloadEntry{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("workloadentries").
...
func (c *workloadEntries) Update(workloadEntry *v1beta1.WorkloadEntry) (result *v1beta1.WorkloadEntry, err error) {
	result = &v1beta1.WorkloadEntry{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("workloadentries").
...
func (c *workloadEntries) UpdateStatus(workloadEntry *v1beta1.WorkloadEntry) (result *v1beta1.WorkloadEntry, err error) {
	result = &v1beta1.WorkloadEntry{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("workloadentries").
...
func (c *workloadEntries) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.WorkloadEntry, err error) {
	result = &v1beta1.WorkloadEntry{}
