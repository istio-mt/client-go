...
type ServiceEntryInterface interface {
	Create(*v1beta1.ServiceEntry) (*v1beta1.ServiceEntry, error)
	Update(*v1beta1.ServiceEntry) (*v1beta1.ServiceEntry, error)
	UpdateStatus(*v1beta1.ServiceEntry) (*v1beta1.ServiceEntry, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta1.ServiceEntry, error)
	List(opts v1.ListOptions) (*v1beta1.ServiceEntryList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.ServiceEntry, err error)
...
func (c *serviceEntries) Get(name string, options v1.GetOptions) (result *v1beta1.ServiceEntry, err error) {
...
func (c *serviceEntries) List(opts v1.ListOptions) (result *v1beta1.ServiceEntryList, err error) {
...
func (c *serviceEntries) Create(serviceEntry *v1beta1.ServiceEntry) (result *v1beta1.ServiceEntry, err error) {
	result = &v1beta1.ServiceEntry{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("serviceentries").
...
func (c *serviceEntries) Update(serviceEntry *v1beta1.ServiceEntry) (result *v1beta1.ServiceEntry, err error) {
	result = &v1beta1.ServiceEntry{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("serviceentries").
...
func (c *serviceEntries) UpdateStatus(serviceEntry *v1beta1.ServiceEntry) (result *v1beta1.ServiceEntry, err error) {
	result = &v1beta1.ServiceEntry{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("serviceentries").
...
func (c *serviceEntries) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.ServiceEntry, err error) {
	result = &v1beta1.ServiceEntry{}
