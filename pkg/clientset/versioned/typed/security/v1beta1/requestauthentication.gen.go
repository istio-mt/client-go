...
type RequestAuthenticationInterface interface {
	...
	UpdateStatus(*v1beta1.RequestAuthentication) (*v1beta1.RequestAuthentication, error)
...
func (c *requestAuthentications) UpdateStatus(requestAuthentication *v1beta1.RequestAuthentication) (result *v1beta1.RequestAuthentication, err error) {
	result = &v1beta1.RequestAuthentication{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("requestauthentications").
